    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-wide pt-32 pb-20">
        <div className="max-w-3xl">
          <h1 className="heading-display mb-6 whitespace-pre-line animate-fade-up">
            {t('hero.headline')}
          </h1>
          <p className="editorial-text max-w-xl mb-10 animate-fade-up" style={{ animationDelay: '0.15s' }}>
            {t('hero.subheadline')}
          </p>
